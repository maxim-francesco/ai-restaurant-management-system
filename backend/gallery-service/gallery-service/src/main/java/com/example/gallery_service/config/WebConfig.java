...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/api/**") // Aplică regula pentru toate endpoint-urile care încep cu /api/
                .allowedOrigins("https://clientapp-648cvri7w-maxim-francescos-projects.vercel.app/", "https://adminapp-l6x3.vercel.app/") // Permite cereri DOAR de la această origine (aplicația ta Angular)
